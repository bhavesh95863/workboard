...
**WorkBoard** is a lightweight, internal company task management app built on the Frappe Framework.  
...
- **Workspace: Workboard**  
  ...
  - Shortcuts: Quick access to WB Task and WB Task Rule.  
...
## **Configuration**
1. **Create Task Rules**  
   - Go to **WB Task Rule** and define recurring or event-based rules.  
   - For recurring: set frequency and due days.  
   - For event-based: set “Based On” and reference doctype.  

2. **Access Workspace**  
   - Open **WorkBoard Dashboard** from the desk to see KPIs, task lists, and charts.
